...
def split_all_users(embeddings_data, train_ratio=0.8, min_test_items=4, random_seed=42):
    """
    Split all users' ratings into train/test sets.
...
def main():
    ...
    parser.add_argument('--output-train', type=str, default='train_users.json',
                        help='Output path for training data (default: train_users.json)')
    parser.add_argument('--output-test', type=str, default='test_users.json',
                        help='Output path for test data (default: test_users.json)')
